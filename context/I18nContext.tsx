...
const enTranslations = {
  ...
  manualEntryTitle: "Log Food Manually",
  manualEntrySubtitle: "Enter the nutritional details for your meal.",
  foodName: "Food Name",
  errorAllFieldsRequired: "Please fill out all fields.",
  logManuallySuccess: "Meal logged manually!",
  uploadAnother: "Upload Another",
  scanAgain: "Scan Again",
  tryAgain: "Try Again",
  analysisErrorTitle: "Analysis Failed",
  emptyHistoryTitle: "Your History is Empty",
  emptyHistoryCta: "Start Tracking",
  ariaLabelEditMeal: "Edit {mealName}",
  ariaLabelUpload: "Upload an image",
  ariaLabelAddManually: "Add meal manually",
...
const arTranslations = {
  ...
  manualEntryTitle: "تسجيل الطعام يدوياً",
  manualEntrySubtitle: "أدخل التفاصيل الغذائية لوجبتك.",
  foodName: "اسم الطعام",
  errorAllFieldsRequired: "يرجى ملء جميع الحقول.",
  logManuallySuccess: "تم تسجيل الوجبة يدوياً!",
  uploadAnother: "رفع صورة أخرى",
  scanAgain: "مسح مرة أخرى",
  tryAgain: "حاول مرة أخرى",
  analysisErrorTitle: "فشل التحليل",
  emptyHistoryTitle: "سجلك فارغ",
  emptyHistoryCta: "ابدأ التتبع",
  ariaLabelEditMeal: "تعديل {mealName}",
  ariaLabelUpload: "رفع صورة",
  ariaLabelAddManually: "إضافة وجبة يدوياً",
  ariaLabelCloseModal: "إغلاق النافذة",
};
